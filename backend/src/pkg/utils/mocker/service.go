...
func (m *MockCall) Return(value ...interface{}) *mock.Call {
	return m.NumberOfCallReturn(1, value...)
}

func (m *MockCall) NumberOfCallReturn(number int, value ...interface{}) *mock.Call {
	idx := number - 1
