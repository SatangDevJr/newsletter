...
import (
	...
	error "subscribetool/src/pkg/utils/error"
...
// SentEmail provides a mock function with given fields:
func (_m *UseCase) SentEmail() *error.ErrorCode {
	ret := _m.Called()

	var r0 *error.ErrorCode
	if rf, ok := ret.Get(0).(func() *error.ErrorCode); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
